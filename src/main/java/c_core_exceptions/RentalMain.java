...
public class RentalMain {
    ...
    public static void main(String[] args) {
        try {getAvailableCars("ABC Rentals S.A."); }
        catch (NoAvailableCarException e) {throw new RuntimeException(e);}
    }
    private  static List<String> getAvailableCars (String rentalName) throws NoAvailableCarException {
        if (cars.isEmpty()) { throw new NoAvailableCarException(rentalName);}
        return cars;
    }
}
