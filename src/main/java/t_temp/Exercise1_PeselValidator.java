/*package pl.adamTomasiewicz.c_programator.a_temp;

import java.time.LocalDate;
import java.util.Scanner;

public class Exercise1_PeselValidator {
    ...
    public static void main(String[] args) {
        ...
        while (!is11chars(input1) && !isAllCharactersDigits(input1)&&is6firstNumbersRealDate() );
...
*//*    private static
    ...
    private static pareBirthDate (String input) {
        for (int i = 0; i < 5 ; i++) {
            this.birthDateDigits[i] = input.charAt(i);
            input.s
